...
export const App: React.FC = () => {
  ...
  const [stack, setStack] = useState<ITechnology[]>(() => {
    const savedStack = localStorage.getItem("devstack_items");
    if (savedStack) {
      try {
  ...
  useEffect(() => {
    localStorage.setItem("devstack_items", JSON.stringify(stack));
  }, [stack]);
  ...
  const handleRemoveAll = () => {
    ...
    setStack([]);
    localStorage.removeItem("devstack_items");
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 text-gray-900 font-sans">
      ...
      <main
        id="technologies"
        className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-1 w-full"
      >
        {isLoading ? (
            ...
            <div className="lg:col-span-8">
              <div className="mb-6">
                ...
                <p className="text-sm text-gray-500">
                  Pick frameworks and services to compose your stack
                </p>
              </div>
